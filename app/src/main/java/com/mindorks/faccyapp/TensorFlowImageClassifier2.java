 ...
 */
public class TensorFlowImageClassifier2 {
    ...
    public TensorFlowImageClassifier2(AssetManager assetManager, String modelFilename, String labelFilename, int inputSize, int imageMean, float imageStd, String inputName, String outputName) {
