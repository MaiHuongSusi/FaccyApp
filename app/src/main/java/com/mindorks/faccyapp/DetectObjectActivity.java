...
public class DetectObjectActivity extends AppCompatActivity {
    ...
    public void show3DObject(View view) {
        Intent intent = new Intent(DetectObjectActivity.this, ThreeModelElectionActivity.class);
        startActivity(intent);
    }

    public void identifyObjects(View view) {
        Intent intent = new Intent(DetectObjectActivity.this, DirectoryActivity.class);
        startActivity(intent);
    }
}
